...
public class XaUtil {
	...
	private final static String FORMATSTR = "yyyy-MM-dd hh:mm:ss";
	/**
...
//		return true;
	...
	public static String formatDate2String(Date date) {
		return formatDate2String(date, FORMATSTR);
	}
	 ...
	 * @return
	 */
	public static Date formateDateLongToDate(String longSecond) {
		//SimpleDateFormat simpleDateFormat = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
		Date date = new Date(Long.valueOf(longSecond));
...
//		}
	...
	/**
	 * 复制文件(以超快的速度复制文件)
	 * 实际复制的字节数，如果文件、目录不存在、文件为null或者发生IO异常
	 * @param srcFile
	 * @param destFile
	 * @return
	 * @throws Exception
	...
	public static String getRandomNumber(int count){
	 ...
	 public static void main(String[] args) {
		 ...
		 //XaUtil.codeFormat("yyyy-MM-dd hh:mm:ss", "2016-03-01 16:12:40.0");
		 System.out.println(formateDateLongToDate("1480488564000"));
	 }
	 
//	 public static String getCreateTimeStr(String createTime) {
//			if(XaUtil.isNotEmpty(createTime) && createTime.length() > 19){
//				createTime = createTime.substring(5, 19);
//				return createTime;
//			}
//			return "";
//		}
	...
	/**
	 * 获取指定时间格式的字符串
	 * @param pattern 格式 如：yyyyMMDDHHmmss的一部分
	 * @return
     */
