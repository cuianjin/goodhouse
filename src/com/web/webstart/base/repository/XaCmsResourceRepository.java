...
public interface XaCmsResourceRepository extends
	 ...
	 * @return
	 */
	@Query("from XaCmsResource xcr where xcr.parentId is null and xcr.status=?1 and xcr.showType=?2 order by xcr.orderNum")
	 ...
	 * @return
	 */
	@Query("from XaCmsResource xcr where xcr.parentId =?1 and xcr.status=?2 order by xcr.orderNum")
