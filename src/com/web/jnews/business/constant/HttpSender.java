...
public class HttpSender {
	...
	public static String sendContent(String mobile,String code){
		...
		String account = "vip-jmt";// 账号
		String pswd = "Tch123456";// 密码
		String msg = "亲爱的用户，您的验证码是" + code + "，请在5分钟之内正确输入。";// 短信内容
	...
	public static String sendMessageToUser(String mobile,String content){
		String url = "http://222.73.117.156/msg/HttpBatchSendSM";// 应用地址
		String account = "vip-jmt";// 账号
		String pswd = "Tch123456";// 密码
		boolean needstatus = true;// 是否需要状态报告，需要true，不需要false
		...
		String extno = null;// 扩展码
		try {
			String returnString = HttpSender.batchSend(url, account, pswd, mobile, content, needstatus, product, extno);
			//System.out.println(returnString);
			if(returnString.split("\n").length == 2){
				return "0000";
			}else{
