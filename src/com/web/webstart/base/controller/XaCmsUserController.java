...
public class XaCmsUserController {
	...
	public XaResult<Page<ViewCmsUser>> showCmsUser(@RequestParam(defaultValue="0") Integer nextPage, @RequestParam(defaultValue="10") Integer pageSize,
		...
		Page<ViewCmsUser> data=xaCmsUserService.getCmsUserByCondition2(filterParams, pageable);
		XaResult<Page<ViewCmsUser>> xr = new XaResult<>();
		xr.setObject(data);
		return xr;
	}
